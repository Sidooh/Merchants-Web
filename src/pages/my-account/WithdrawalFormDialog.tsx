...
import { useWithdrawEarningsMutation } from '@/services/merchants/merchantsEndpoints.ts';
...
const formSchema = yup.object({
    ...
    amount: yup.number().min(10).typeError('Please enter amount').required('Amount is required.'),
    account: yup
        .string()
...
const WithdrawalFormDialog = ({ source, open, setOpen }: WithdrawalFormDialogProps) => {
    ...
    const [withdrawEarnings, { isLoading, error }] = useWithdrawEarningsMutation();
